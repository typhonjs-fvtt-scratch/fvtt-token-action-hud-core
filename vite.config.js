...
// the dev server.
const s_PACKAGE_ID = 'modules/token-action-hud-core'
...
export default () => {
    ...
    return {
        ...
        // directories: `assets`, `lang`, and `packs` and will pull those resources from the main Foundry / 30000
        // server. This is necessary to reference the dev resources as the root is `/src` and there is no public /
        // static resources served with this particular Vite configuration. Modify the proxy rule as necessary for your
        ...
        build: {
            ...
            target: ['es2022'],
            terserOptions: s_COMPRESS ? { ...terserConfig(), ecma: 2022 } : undefined,
            lib: {
                entry: './index.js',
                formats: ['es'],
                fileName: 'index'
